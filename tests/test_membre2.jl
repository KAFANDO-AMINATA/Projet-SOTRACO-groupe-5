...
@testset "Tests Module Visualisation" begin
    ...
    @testset "Affichage stats ligne - pas d'erreur" begin
        # Test que la fonction s'exécute sans erreur
        @test_nowarn afficher_stats_ligne(test_stats, test_lignes)
    end
    
    @testset "Affichage heures de pointe - pas d'erreur" begin
        @test_nowarn afficher_heures_pointe(test_heures)
    end
    
    @testset "Affichage taux occupation - pas d'erreur" begin
    ...
    @testset "Affichage arrêts populaires - pas d'erreur" begin
    ...
    @testset "Résumé exécutif - pas d'erreur" begin
...
@testset "Tests Intégration Interface" begin
    ...
    @testset "Menu principal - pas d'erreur" begin
